...
# Example on how to call it below.
# CancerTrainX is the training set of size (400 by 30)
# CancerTrainY is the label set of size (400 by 1)
print fisher_index_calc(cancerTrainX, cancerTrainY)